...
st.set_page_config(layout="wide", page_title="chatPdf", page_icon=":robot_face:")  # Set app to wide mode and customize title and icon
...
if not st.session_state.authenticated:
    st.title("Welcome to chatPdf")

    # Add an input field for the user to enter the passkey
    passkey = st.text_input("🚀 Ready to dive into document analysis? Authenticate with the passkey", type="password")
    ...
    st.image("cool logo.png", width=600)
